...
**Also read `/workspace/group/company.md` — echo-Wisdom context and Limor's outreach style. Full templates are in `/workspace/extra/shaul-work/`.**
...
| `/workspace/extra/shaul-work` | `~/Shaul Work` on host | read-write |
